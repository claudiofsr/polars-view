use crate::{
    DataFrameContainer, Error, FileExtension, MyStyle, Notification, PolarsViewError,
    PolarsViewResult, Settings,
            ...
            Ok(data) => {
                match data {
                    ...
                    Err(err) => {
                        ...
                        // Simplified error handling:  Construct the error Notification *directly* here.
                        ...
                        // Create and display the error Notification.
    ...
    fn update(&mut self, ctx: &Context, _frame: &mut eframe::Frame) {
        ...
        CentralPanel::default().show(ctx, |ui| {
            ...
            match self.df.as_ref().clone() {
                Some(df_container) => {
                    // Dataframe is loaded and available in df_container. Display the table.
                    ScrollArea::horizontal().show(ui, |ui| {
                        ...
                        // Render the data table using the df_container's render_table method.
                        // This method returns optional filters applied by the user in the table UI.
                ...
                None => {
                    // Dataframe is not loaded (self.df is None).
                    ...
                    if self.check_data_pending() {
                        ...
                        // Display a prompt message to the user to drag and drop a parquet file.
                        ui.centered_and_justified(|ui| {
