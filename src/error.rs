...
// Helper needed if using regex crate
impl From<regex::Error> for PolarsViewError {
    fn from(err: regex::Error) -> Self {
        // You might want a more specific variant, but Other works
        // Or map specific regex errors if needed.
        PolarsViewError::Other(format!("Regex compilation/matching error: {}", err))
    }
}
